            ...
            <div class="table-container">
                <table>
                    ...
                    <?php foreach ($courses as $course): ?>
                        <tr>
                            <td><?= htmlspecialchars((string)$course['course_id']) ?></td>
                            <td><?= htmlspecialchars((string)$course['course_name']) ?></td>
                            <td><?= htmlspecialchars((string)$course['credits']) ?></td>
                            <td>
                                <span class="enrollment-count"><?= htmlspecialchars((string)$course['enrolled_students']) ?> students</span>
                            </td>
                            <td>
                                <button class="view-btn view-btn-text" onclick="showCourseDetails(<?= htmlspecialchars((string)$course['course_id']) ?>)">View</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
