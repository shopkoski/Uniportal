-- Enroll ALL students in various courses with grades
-- This will give every student grades to display

-- First, let's see how many students we have
SELECT 'Total Students:' as Info, COUNT(*) as Count FROM Students_Table_1;
...
-- Computer Networks (Course ID: 4)
INSERT INTO Enrollments_Table_1 (student_id, course_id, grade) VALUES
(11, 4, 7.0), (12, 4, 8.5), (13, 4, 9.0), (14, 4, 6.0), (15, 4, 8.0),
(16, 4, 7.5), (17, 4, 9.5), (18, 4, 8.5), (19, 4, 7.0), (20, 4, 8.0);

-- Calculus (Course ID: 5)
INSERT INTO Enrollments_Table_1 (student_id, course_id, grade) VALUES
(11, 5, 8.5), (12, 5, 7.0), (13, 5, 9.5), (14, 5, 6.5), (15, 5, 8.0),
(16, 5, 7.5), (17, 5, 9.0), (18, 5, 8.5), (19, 5, 7.0), (20, 5, 8.0);
...
-- Operating Systems (Course ID: 6)
INSERT INTO Enrollments_Table_1 (student_id, course_id, grade) VALUES
(21, 6, 7.0), (22, 6, 8.5), (23, 6, 9.0), (24, 6, 6.5), (25, 6, 8.0),
(26, 6, 7.5), (27, 6, 9.5), (28, 6, 8.0), (29, 6, 7.5), (30, 6, 8.5);
...
SELECT 
    'Average Grade:', 
    CAST(AVG(CAST(grade AS FLOAT)) AS DECIMAL(4,2))
FROM Enrollments_Table_1;
