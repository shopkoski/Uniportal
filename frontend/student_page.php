...
?>
<!DOCTYPE html>
<!-- CACHE BUST: <?php echo time(); ?> - REMOVED DELETE TOGGLE BUTTON -->
<html lang="en">
<head>
    <meta charset="UTF-8" />
...
<div id="studentModal" class="modal">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        setTimeout(ensurePlusButtonVisibility, 1500);
        

    });

    // Function to ensure add button is visible for authorized users
    function ensurePlusButtonVisibility() {
        const addBtn = document.getElementById('addStudentBtn');
        const delBtn = document.getElementById('deleteToggleBtn');
        
        console.log('Add button found:', !!addBtn);
        console.log('Delete button found:', !!delBtn);
        
        // Check if user is logged in and has proper role
        const isLoggedIn = Auth.isLoggedIn();
        const user = Auth.getUser();
        const isAuthorized = isLoggedIn && user && (user.role === 'Admin' || user.role === 'Professor');
        ...
        if (delBtn) {
            console.log('Delete button exists, forcing visibility');
            delBtn.style.display = 'inline-flex !important';
            delBtn.style.visibility = 'visible !important';
            delBtn.style.opacity = '1 !important';
            delBtn.style.background = 'red !important';
        } else {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        fetch('get_all_students.php')
            ...
            .catch(err => {
                document.getElementById('studentsContainer').innerHTML = `<p>Error loading students: ${err.message}</p>`;
            });
    });
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th class="th-delete" id="studentsDeleteHeader" style="text-align: center !important;">Delete</th>
                    </tr>
                </thead>
                <tbody>
        `;
